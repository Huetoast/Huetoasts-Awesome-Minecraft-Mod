...
public class BruhBowlItem extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:bruh_bowl")
	public static final Item block = null;
	public BruhBowlItem(TestestsetestModElements instance) {
		super(instance, 172);
	}
