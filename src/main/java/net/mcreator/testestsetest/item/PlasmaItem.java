...
public class PlasmaItem extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:plasma")
	public static final Item block = null;
	public PlasmaItem(TestestsetestModElements instance) {
		super(instance, 13);
	}
