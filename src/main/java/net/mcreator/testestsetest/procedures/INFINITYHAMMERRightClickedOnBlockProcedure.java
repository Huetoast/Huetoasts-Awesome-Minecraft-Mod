...
public class INFINITYHAMMERRightClickedOnBlockProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TestestsetestMod.LOGGER.warn("Failed to load dependency entity for procedure INFINITYHAMMERRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				TestestsetestMod.LOGGER.warn("Failed to load dependency x for procedure INFINITYHAMMERRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				TestestsetestMod.LOGGER.warn("Failed to load dependency y for procedure INFINITYHAMMERRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				TestestsetestMod.LOGGER.warn("Failed to load dependency z for procedure INFINITYHAMMERRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				TestestsetestMod.LOGGER.warn("Failed to load dependency world for procedure INFINITYHAMMERRightClickedOnBlock!");
			return;
		}
