...
package net.mcreator.testestsetest.world.biome;
...
import net.mcreator.testestsetest.block.WsadBlock;
import net.mcreator.testestsetest.block.FvfBlock;
import net.mcreator.testestsetest.block.DaBlock;
import net.mcreator.testestsetest.block.AsjnLogBlock;
import net.mcreator.testestsetest.block.AsjnLeavesBlock;
...
public class GfsfBiome extends TestestsetestModElements.ModElement {
	public static Biome biome;
	public GfsfBiome(TestestsetestModElements instance) {
		super(instance, 93);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(SliimeEntity.entity, 20, 8, 12));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(SliimeEntity.entity, 20, 4, 62));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(SliimeEntity.entity, 20, 4, 62));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(SliimeEntity.entity, 20, 4, 624));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(SliimeEntity.entity, 20, 4, 624));
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.1f).scale(0.2f).temperature(0.5f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("testestsetest:gfsf"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, WsadBlock.block.getDefaultState(), sbc, mbb);
		}
	}
