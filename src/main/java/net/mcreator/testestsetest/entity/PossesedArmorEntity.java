...
package net.mcreator.testestsetest.entity;
...
import net.mcreator.testestsetest.entity.renderer.PossesedArmorRenderer;
...
public class PossesedArmorEntity extends TestestsetestModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("possesed_armor").setRegistryName("possesed_armor");
	public PossesedArmorEntity(TestestsetestModElements instance) {
		super(instance, 100);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PossesedArmorRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("possesed_armor_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("testestsetest:gfsf").equals(event.getName()))
			biomeCriteria = true;
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 100, 4, 106));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, SliimeEntity.CustomEntity.class, true, true));
