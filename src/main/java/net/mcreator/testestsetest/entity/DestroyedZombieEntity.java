...
import net.mcreator.testestsetest.item.RepetComadnArmorItem;
import net.mcreator.testestsetest.item.Command_BlockSwordItem;
import net.mcreator.testestsetest.entity.renderer.DestroyedZombieRenderer;
import net.mcreator.testestsetest.TestestsetestModElements;

import java.util.Random;

@TestestsetestModElements.ModElement.Tag
public class DestroyedZombieEntity extends TestestsetestModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("destroyed_zombie").setRegistryName("destroyed_zombie");
	public DestroyedZombieEntity(TestestsetestModElements instance) {
		super(instance, 166);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DestroyedZombieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -3355444, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("destroyed_zombie_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 50, 1, 16));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.KNOCKBACK_RESISTANCE, 754);
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 567;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Command_BlockSwordItem.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(RepetComadnArmorItem.helmet));
		}
