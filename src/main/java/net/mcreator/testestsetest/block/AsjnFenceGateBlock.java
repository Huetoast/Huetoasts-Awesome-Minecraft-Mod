...
public class AsjnFenceGateBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_fence_gate")
	public static final Block block = null;
	public AsjnFenceGateBlock(TestestsetestModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("asjn_fence_gate");
		}
