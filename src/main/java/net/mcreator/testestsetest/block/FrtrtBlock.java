...
public class FrtrtBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:frtrt")
	public static final Block block = null;
	public FrtrtBlock(TestestsetestModElements instance) {
		super(instance, 96);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("frtrt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("testestsetest:frtrt"), configuredFeature);
		}
	}
	@SubscribeEvent
