...
public class SwrgdggdfdfgfdggfddgffddgfdfgdgsdasdggBlockBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:swrgdggdfdfgfdggfddgffddgfdfgdgsdasdgg_block")
	public static final Block block = null;
	public SwrgdggdfdfgfdggfddgffddgfdfgdgsdasdggBlockBlock(TestestsetestModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("swrgdggdfdfgfdggfddgffddgfdfgdgsdasdgg_block");
		}
