...
public class AsjnStairsBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_stairs")
	public static final Block block = null;
	public AsjnStairsBlock(TestestsetestModElements instance) {
		super(instance, 76);
	}
