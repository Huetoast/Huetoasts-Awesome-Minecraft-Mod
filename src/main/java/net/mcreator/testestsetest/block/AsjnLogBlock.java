...
public class AsjnLogBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_log")
	public static final Block block = null;
	public AsjnLogBlock(TestestsetestModElements instance) {
		super(instance, 73);
	}
