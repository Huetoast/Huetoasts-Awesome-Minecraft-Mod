...
public class GtttttttttttttttttttttttttttttttttttttttttttttttttttttttttButtonBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:gttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_button")
	public static final Block block = null;
	public GtttttttttttttttttttttttttttttttttttttttttttttttttttttttttButtonBlock(TestestsetestModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("gttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_button");
		}
