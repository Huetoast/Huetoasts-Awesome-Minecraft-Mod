...
public class AsjnPressurePlateBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_pressure_plate")
	public static final Block block = null;
	public AsjnPressurePlateBlock(TestestsetestModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("asjn_pressure_plate");
		}
