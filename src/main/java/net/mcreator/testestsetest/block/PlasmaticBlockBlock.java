...
public class PlasmaticBlockBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:plasmatic_block")
	public static final Block block = null;
	public PlasmaticBlockBlock(TestestsetestModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("plasmatic_block");
		}
