...
public class AsjnButtonBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_button")
	public static final Block block = null;
	public AsjnButtonBlock(TestestsetestModElements instance) {
		super(instance, 81);
	}
