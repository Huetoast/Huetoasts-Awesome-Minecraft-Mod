...
public class GtttttttttttttttttttttttttttttttttttttttttttttttttttttttttSlabBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:gttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_slab")
	public static final Block block = null;
	public GtttttttttttttttttttttttttttttttttttttttttttttttttttttttttSlabBlock(TestestsetestModElements instance) {
		super(instance, 151);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("gttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_slab");
		}
