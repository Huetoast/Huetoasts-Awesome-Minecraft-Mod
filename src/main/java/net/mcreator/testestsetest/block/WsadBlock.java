...
public class WsadBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:wsad")
	public static final Block block = null;
	public WsadBlock(TestestsetestModElements instance) {
		super(instance, 93);
	}
