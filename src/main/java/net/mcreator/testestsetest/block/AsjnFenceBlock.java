...
public class AsjnFenceBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_fence")
	public static final Block block = null;
	public AsjnFenceBlock(TestestsetestModElements instance) {
		super(instance, 78);
	}
