...
public class BryhbrhruBlockBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:bryhbrhru_block")
	public static final Block block = null;
	public BryhbrhruBlockBlock(TestestsetestModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bryhbrhru_block");
		}
