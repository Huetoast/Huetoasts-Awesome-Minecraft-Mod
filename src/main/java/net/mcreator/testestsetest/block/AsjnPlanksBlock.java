...
public class AsjnPlanksBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_planks")
	public static final Block block = null;
	public AsjnPlanksBlock(TestestsetestModElements instance) {
		super(instance, 74);
	}
