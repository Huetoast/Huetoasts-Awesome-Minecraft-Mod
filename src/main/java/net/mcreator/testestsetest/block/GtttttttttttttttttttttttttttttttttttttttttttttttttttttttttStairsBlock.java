...
public class GtttttttttttttttttttttttttttttttttttttttttttttttttttttttttStairsBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:gttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_stairs")
	public static final Block block = null;
	public GtttttttttttttttttttttttttttttttttttttttttttttttttttttttttStairsBlock(TestestsetestModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("gttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_stairs");
		}
