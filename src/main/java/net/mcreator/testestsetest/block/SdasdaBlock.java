...
public class SdasdaBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:sdasda")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("testestsetest:sdasda_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public SdasdaBlock(TestestsetestModElements instance) {
		super(instance, 169);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				CustomFluidAttributes.builder(new ResourceLocation("testestsetest:blocks/fgd"), new ResourceLocation("testestsetest:blocks/fgd"))
		...
		still = (FlowingFluid) new CustomFlowingFluid.Source(fluidproperties).setRegistryName("sdasda");
		flowing = (FlowingFluid) new CustomFlowingFluid.Flowing(fluidproperties).setRegistryName("sdasda_flowing");
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new LakesFeature(BlockStateFeatureConfig.field_236455_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, BlockStateFeatureConfig config) {
					...
					if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("testestsetest:dsfdsf")))
						dimensionCriteria = true;
			...
			event.getRegistry().register(feature.setRegistryName("sdasda_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("testestsetest:sdasda_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
