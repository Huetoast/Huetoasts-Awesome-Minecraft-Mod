...
public class AsjnLeavesBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_leaves")
	public static final Block block = null;
	public AsjnLeavesBlock(TestestsetestModElements instance) {
		super(instance, 75);
	}
