...
public class AsjnSlabBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_slab")
	public static final Block block = null;
	public AsjnSlabBlock(TestestsetestModElements instance) {
		super(instance, 77);
	}
