...
public class AsjnWoodBlock extends TestestsetestModElements.ModElement {
	@ObjectHolder("testestsetest:asjn_wood")
	public static final Block block = null;
	public AsjnWoodBlock(TestestsetestModElements instance) {
		super(instance, 72);
	}
